<script>
  ...
  let expanded =
    JSON.parse(localStorage.getItem('admin-sidenav')) ||
    localStorage.setItem('admin-sidenav', false);
...
<nav
  ...
  <ul class="mt-auto">
    ...
    <li>
      <a href="/" title="Logout" use:link><i class="mdi mdi-logout" />
